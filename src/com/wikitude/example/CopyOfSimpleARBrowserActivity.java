 ...
 */
public class CopyOfSimpleARBrowserActivity extends Activity implements ArchitectUrlListener, LocationListener{
	
	private static final String TAG = CopyOfSimpleARBrowserActivity.class.getSimpleName();
	...
	private void loadSampleWorld() throws IOException {
		this.architectView.load("MSSARProject.html");
